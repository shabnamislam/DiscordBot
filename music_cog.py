...
class music_cog(commands.Cog):
    ...
    async def play_music(self):
        if len(self.music_queue) > 0:
            ...
            #try to connect to voice channel if u r not already connected
            ...
            #remove the first element as u r currently playing it
            self.music_queue.pop(0)
    ...
    async def p(self, ctx, *args):
        ...
        if voice_channel is None:
            #you need to b connected so that the bot knows where to go
